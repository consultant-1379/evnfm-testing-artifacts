...
{{- define "eric-data-document-database-pg.log-shipper-sidecar-aggregated-merge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-data-document-database-pg.log-shipper-sidecar-merge-annotations" -}}
  {{- include "eric-data-document-database-pg.log-shipper-sidecar-aggregated-merge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-data-document-database-pg.log-shipper-sidecar-merge-labels" -}}
  {{- include "eric-data-document-database-pg.log-shipper-sidecar-aggregated-merge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}