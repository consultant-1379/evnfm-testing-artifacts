...
{{- define "eric-pm-bulk-reporter.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-pm-bulk-reporter.mergeAnnotations" -}}
  {{- include "eric-pm-bulk-reporter.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-pm-bulk-reporter.mergeLabels" -}}
  {{- include "eric-pm-bulk-reporter.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
