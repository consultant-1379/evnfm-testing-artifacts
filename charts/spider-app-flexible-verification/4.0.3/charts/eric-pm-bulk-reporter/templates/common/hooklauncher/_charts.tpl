{{/* List of subcharts of this chart
     ...
     Uses the template eric-pm-bulk-reporter.hkln.subcharts as an
     ...
     e.g.,
     {{- define "eric-pm-bulk-reporter.hkln.subcharts" -}}
...
*/}}
{{- define "eric-pm-bulk-reporter.hkln.directSubcharts" -}}
{{ block "eric-pm-bulk-reporter.hkln.subcharts" .}}{{ end }}
{{- end -}}

{{- define "eric-pm-bulk-reporter.hkln.hasSHH" -}}
...
{{- define "eric-pm-bulk-reporter.hkln.chartInfo" -}}
{{- if eq "true" (include "eric-pm-bulk-reporter.hkln.hasSHH" .) }}
{{ include "eric-pm-bulk-reporter.hkln.name" . }}:
  jobInventorySecret: {{ include "eric-pm-bulk-reporter.hkln.job-inventory-secret-name" . }}
  version: {{ .Chart.Version | quote }}
{{- end -}}
{{- if eq (include "eric-pm-bulk-reporter.hkln.executor" .) "integration" -}}
{{- range $subChartName, $subChartContext := .Subcharts }}
{{ include "eric-pm-bulk-reporter.hkln.chartInfo" $subChartContext }}
{{- end -}}
{{- end -}}
{{- end -}}
